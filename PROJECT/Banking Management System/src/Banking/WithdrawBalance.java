 ...
 * @author Akshay Kumar
 */
public class WithdrawBalance extends javax.swing.JFrame {

    /**
     * Creates new form WithdrawBalance
     */
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cash", "Cheque", "RPGS" }));
        getContentPane().add(jComboBox1);
        jComboBox1.setBounds(140, 230, 200, 30);

        jLabel8.setFont(new java.awt.Font("Sitka Small", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Debit Amount");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(10, 280, 88, 20);
    ...
    double deb=Double.parseDouble(jTextField5.getText());
    ...
    String query2="Insert into balancesheet values('"+acc+"', '"+date+"', '"+mode+"', NULL, "+deb+", "+newbal+", NULL);";
    if(deb<=oldbal)
    {
    try{
        Class.forName("com.mysql.jdbc.Driver");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WithdrawBalance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WithdrawBalance().setVisible(true);
            }
        });
    }
