 ...
 * @author Akshay Kumar
 */
public class ViewDraft extends javax.swing.JFrame {

    /**
     * Creates new form ViewDraft
     */
    public ViewDraft() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Draft No.", "Date", "In Favour", "Account No.", "Amount"
            }
        ));
    ...
    try{
        ...
        ResultSet rs=st.executeQuery("Select * from draft where Date='"+date+"';");
        while(rs.next())
       {
            String s1=rs.getString("Draftno");
            String s2=rs.getString("Date");
            String s3=rs.getString("Favour");
            String s4=rs.getString("Accountno");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDraft.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
